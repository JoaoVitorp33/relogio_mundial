...
# Instalar o pillow: pip install pillow
...
# importando lista dos paises

# importando o  Python zonas
...
frameDireita = Frame(janela, width=300, height=140, bg=co0, relief=FLAT)
frameDireita.grid(row=1, column=0, pady=1, padx=0, sticky=NSEW)

frameDireita_conteudo_0 = Frame(
    frameDireita, width=300, height=35, bg=co1, relief=RAISED)
frameDireita_conteudo_0.grid(row=0, column=0, pady=0, padx=0, sticky=NSEW)

frameDireita_conteudo_1 = Frame(
    frameDireita, width=300, height=155, bg=co1, relief=FLAT)
...
app_logo = Label(frameCima, image=app_img, text=' Relógio mundial', width=920,
                 compound=LEFT, relief=FLAT, anchor=NW, font=('digital-7 25'), bg=co1, fg=co0)
app_logo.place(x=0, y=0)

# Trabalhando no frame conteudo 1 -----------------------------------

l_zona = Label(frameDireita_conteudo_0, text="Fuso Horario *",
               width=35, height=1, anchor=NW, font=('Ivy 10 '), bg=co1, fg=co0)
...
l_cidade = Label(frameDireita_conteudo_1, text='New York',
                 anchor=NW, font=('Arial 10 '), bg=co1, fg=co0)
l_cidade.place(x=10, y=8)

l_pais = Label(frameDireita_conteudo_1, text='USA',
               anchor=NW, font=('Arial 10 '), bg=co1, fg=co0)
l_pais.place(x=10, y=28)

l_horas = Label(frameDireita_conteudo_1, text="10:05:05",
                font=('digital-7  25 bold'), bg=co1, fg=co2)
l_horas.place(x=10, y=45)

l_periodo = Label(frameDireita_conteudo_1, text='PM',
                  anchor=NW, font=('Verdana 10'), bg=co1, fg=co2)
l_periodo.place(x=150, y=60)
...
def relogio():
    ...
    l_data.config(text=dia_da_semana + ", " + "" + str(dia) +
                  " " + str(mes) + " " + (ano) + " " + (periodo))
    ...
    l_icon = Label(frameDireita_conteudo_1,
                   image=img_bandeira, bg=co0, relief='solid')
